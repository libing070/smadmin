...
<body class="bg-yellow">
	<div class="qiangguang-touxiang">
		<span><br><img id="imgNameId" width="30" align="absmiddle" /></span>
	...
	<div class="clearfix qiangguang-tishi-block">
		...
		<div class="qiangguang-tishi">
			<span class="font-small">额...红包过期啦！过期啦过期啦！</span>
		</div>
	</div>
	<div>
		<img src="<%=ctxPath%>/resources/images/pic_guoqi.jpg" width="100%" />
	</div>
		...
		<div class="qiang-block-red">
			...
			<div class="bg-yellow">
				...
				<div class="clearfix jiange-block qiangguang-friend">
					<div class="qiangguang-friend-title">
						<span class="bg-yellow">看朋友们手气如何</span>
					</div>
				</div>
