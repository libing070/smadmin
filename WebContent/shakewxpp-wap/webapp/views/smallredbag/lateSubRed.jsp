...
<body class="bg-yellow">
	<div class="qiangguang-touxiang">
		<span><img id="imgNameId" width="30" align="absmiddle" /></span>
		<span class="qiangguang-user" id="userId"></span>
	</div>

	<div class="clearfix qiangguang-tishi-block">
		<div class="qiangguang-conner"></div>
		<div class="qiangguang-tishi">
			<span class="font-small">你来晚了！下次早点来，么么哒！</span>
		</div>
	</div>

	<div>
		<img src="<%=ctxPath%>/resources/images/pic_laiwanle2.jpg" width="100%" />
	</div>

	<div class="qiang-layout-red">
		<div class="qiang-topborder"></div>
		<div class="qiang-block-red">
			<!--  <div class="yellow-btn clearfix">下载流量汇客户端</div>-->
			<div class="yellow-btn clearfix" onclick="javascript:goTosend('${weixinAppNo}');">我也要免费发红包</div>
			<div class="qiang-bottom-red"></div>
			
			<div class="bg-yellow">
				<div class="blank-jiange clearfix"></div>
				<div class="qiangguang-mingxi clearfix">
					<div class="l"><img src="<%=ctxPath%>/resources/images/icon_money2.png" width="30" align="absmiddle" />我抢到的红包总额</div>
					<div class="r"><span class="font-red" id="flowId">0</span>流量币</div>
				</div>
				<div class="blank-jiange clearfix"></div>
				<div class="clearfix jiange-block qiangguang-friend">
					<div class="qiangguang-friend-title"><span class="bg-yellow">看朋友们手气如何</span></div>
				</div>
       	 ...
       	 success : function(data) {
       	 	if(data.CODE=="TRUE"){
	       	 	...
	       	 	if(list!=null){
		       	 	...
		       	 	for(var i in list){
		       	 		var grabFlow = list[i];
		       	 		dataHtml+="<div class='clearfix qiang-friend qiangguang-friend-text'>";
						...
						dataHtml+="</div>"
						dataHtml+="<div class='qiang-friend-m font-small'>"+grabFlow.grabTime_toString+"</div>";
