...
<body class="bg-red">
	  <div class="qiang-touxiang"><span><img id="imgNameId" width="30" align="absmiddle"/></span><span class="qiang-user" id="userId"></span></div>
	  <div class="clearfix qiangguang-tishi-block">
	    <div class="qiangguang-conner"></div>
	    <div class="qiangguang-tishi"><span class="font-small font-red">恭喜抢到我的流量红包，可以兑换流量！</span></div>
	  </div>
	...
	<div class="qiang-layout">
		...
		<div class="qiang-block">
			...
			<div class="guanlian-layout centertext font-small">请于<span id="qinquId"><c:out value="${qiangResult.expiredTime}"/></span>前<br>到流量汇"我的帐户"领取</div>
			<div class="yellow-btn clearfix" onclick="javascript:goClient();">立即去流量汇领取</div>
			<!--<div class="yellow-btn clearfix">下载流量汇客户端</div>-->
			<div class="yellow-btn clearfix" onclick="javascript:goTosend('${user.weixinAppNo}');">我也要免费发红包</div>
			<div class="qiang-bottom"></div>
			
			<div class="bg-red qiang-mingxi clearfix">
				<div class="l">
					<img src="<%=ctxPath%>/resources/images/icon_money.png" width="30" align="absmiddle" />
					我抢到的红包总额
				</div>
       	 ...
       	 success : function(data) {
       	 	if(data.CODE=="TRUE"){
	       	 	...
	       	 	if(list!=null){
						...
						dataHtml+="<div class='qiang-friend-l'>";
						var head_imgUrl = grabFlow.imgName==null?'<%=ctxPath%>/resources/images/icon_touxiang.jpg':grabFlow.imgName;
						dataHtml+="<img src='"+head_imgUrl+"' align='absmiddle' width='30' />"+(grabFlow.nickName==null?"好友":grabFlow.nickName);
						dataHtml+="</div>"
