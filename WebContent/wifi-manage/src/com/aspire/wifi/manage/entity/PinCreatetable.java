...
public class PinCreatetable extends BaseDomain{
	...
	public Long[] getFlashSaleIds() {
		return flashSaleIds;
	}

	public void setFlashSaleIds(Long[] flashSaleIds) {
		this.flashSaleIds = flashSaleIds;
	}
