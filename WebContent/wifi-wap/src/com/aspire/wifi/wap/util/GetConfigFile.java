...
public class GetConfigFile {
	...
	private GetConfigFile() throws Exception{
		...
		props.load(new FileInputStream(System.getProperty("user.dir")+System.getProperty("file.separator")+"wifi-wap"+System.getProperty("file.separator")+"conf"+System.getProperty("file.separator")+"system.properties"));
	}
