...
public abstract class FTPCommand {
	...
	private static Logger logger =  LoggerFactory.getLogger("FTPCommand.class");
     ...
     * @param account
     */
    public FTPCommand(FTPAccount account) {
    ...
    public void excecute(InputStream inPutStream,String fileName) throws Exception {
        //连接
        this.connect();
        //执行FTP命令
        this.doFTP(inPutStream,fileName);
        //退出
        this.quit();
    }
...
//                }
     ...
     * 执行ftp命令
     */
    protected abstract void doFTP(InputStream inPutStream, String fileName) throws Exception;
