...
<body>
	...
	<div class="login-step-block">
		<div class="login-step-normal">登录</div>
	</div>
	<div class="login-step-block">
		<div class="login-step-active">完善个人资料</div>
	</div>
</div>
	<!--头部结束-->
<div class="jiange-dashline"></div>
<div class="login-block clearfix"><table width="100%" border="0" cellspacing="2" cellpadding="3">
  <tr>
    <td width="70">头像：</td>
    <td><div id="myHeadShowId"><img src="<%=ctxPath%>/resources/images/nan.png" width="50" height="50" /></div>
