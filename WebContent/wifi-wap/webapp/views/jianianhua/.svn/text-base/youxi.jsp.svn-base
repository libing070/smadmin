...
<script data-main="<%=ctxPath%>/resources/js/main2" src="<%=ctxPath%>/resources/js/require.js"></script>
...
window.shareData = {
    "imgUrl": "http://g.huceo.com/weixin/qixi1/images/logo.png",
    "timeLineLink": "http://g.huceo.com/weixin/qixi1/",
    "tTitle": "坚持住，牛郎！织女靠你了！",
...
function shareGame(t){
   ...
   //   window.shareData.tTitle = document.title;
    var url_=ctxPaths+'/jianianhua/guaguale?score='+parseInt(score);
...
<div id="share" style="display: none;">
    <img width=100% src="<%=ctxPath %>/resources/images/share.png" style="position: fixed;z-index:9999; top: 0; left: 0; display: " ontouchstart="document.getElementById('share').style.display='none';">
