...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(116.249157,40.230497);//定义一个中心点坐标
    ...
    var markerArr = [{title:"终点",content:"黄记煌满汉焖品",point:"116.24339|40.230263",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ,{title:"起点",content:"乘坐昌13空军第二十三厂全程的4分钟",point:"116.254116|40.230883",isOpen:1,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
...
//标注线数组
    ...
    var plPoints = [{style:"solid",weight:4,color:"#f00",opacity:0.6,points:["116.243408|40.23018","116.254224|40.230896","116.254188|40.23091"]}
		 ];
    //向地图中添加线函数
