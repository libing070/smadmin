...
<body>
	...
	<div class="qiangzhuo-chenggong" id="qiang_success">
		<img src="<%=ctxPath%>/resources/images/qiangzhuo_jiaru_chenggong.jpg" width="100%" />
		<div class="notes">注：你可以在“我的”－“我的活动”里查看详情</div>
		<div class="step">
			<span onclick="javascript:huodongPage();">还有别的活动，去看看</span><span><img src="<%=ctxPath%>/resources/images/icon_arrow01.png" align="absmiddle" /></span>
		</div>
	</div>
