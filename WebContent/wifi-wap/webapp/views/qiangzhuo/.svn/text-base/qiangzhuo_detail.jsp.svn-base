...
<script type="text/javascript">
	...
	function initPinZhuoDetails(pinCreateTableEntity, loginMobile) {
		...
		if (loginMobile == pinCreateTableEntity.ownerMobile) {
			...
			$("#ownerMobile").html(maskMobilePhone(pinCreateTableEntity.ownerMobile));
		}
...
<body>
	...
	<div class="qiangzhuo-detail">
		...
		<div class="boldfont remain jiange-top">可加：<span id="freeSeat" class="font-blue"></span>人</div>
		<div class="btn">
			<span class="join"
				onclick="javascript:joinPinZhuo()">加入</span><span
				class="other" onclick="javascript:history.back();">看看别的</span>
		</div>
	</div>
