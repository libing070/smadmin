...
public interface SmiShopInfoMapper {
	 ...
	 *            门店编码
	 */
	public SmiShopInfo getByNoAndPwd(@Param("shopPassword") String password, @Param("shopNo") String shopNo);
	public SmiShopInfo getByShopNO(@Param("shopNo") String shopNo);
